...
createApp({
  data() {
    return {
      url: "https://api.thecatapi.com/v1/images/search?limit=22&api_key=live_ZPos8Cf92a8GhQ4sg3pU8H1gyx3KLs8yP3XQjqG76nvnXpQBiZkE73g9OmFIX0Ze",
      gatos: [],
    }
  ...
  data() {
    return {
      url: "https://api.thecatapi.com/v1/images/search?limit=12&api_key=TU_API_KEY", 
      gatos: [],
      textos: [
        "Un gato puede correr hasta 48 km/h.",
